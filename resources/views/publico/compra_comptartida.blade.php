...
<div class="container" style="margin-top: 70px;" id="main_container">
	...
	<div class="panel-heading">
		<center>
			<h2>Compra Compartida de {{$compra['usuario']['nombre']}} {{$compra['usuario']['apellido']}}</h2>
			<img src="{{url('/')}}{{$compra['usuario']['url_foto_perfil']}}" class="img-responsive" style="max-height: 150px;">
		</center>
	</div>
			...
			<div class="list-group">
					...
					<div  class="list-group-item">
						...
						<div class="list-group-item-text">
							<center>
								<img src="{{url('/')}}{{$compra['moto']->color->url_thumbnail}}" class="img-responsive" style="max-height: 300px;">
							...
							<center>
									...
									<img src="{{url('/')}}{{$accesorio->url_thumbnail}}" class="img-responsive" style="max-height: 150px;">
