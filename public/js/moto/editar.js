...
function editarMoto(){
	...
	var settings = {
		"async": true,
		"crossDomain": true,
		"url": base_url+"/service/motos/editar",
		"method": "POST",
		"headers": {
...
function completarFormulario() {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": base_url+"/service/motos/"+id,
    "method": "GET",
  }

  $.ajax(settings).done(function (response) {

    $("#tipo").val(response.content.tipo);
    $("#marca").val(response.content.marca);
    $("#cilindraje").val(response.content.cilindraje);
    $("#modelo").val(response.content.modelo);
    $("#precio").val(response.content.precio);
    $("#url").val(response.content.url_video);
    $("#rating").val(response.content.rating);
  });
